...
router.get('/?', function(req, res) {
    ...
    var script = 'function player(){var a=document.querySelector("#yohoho");if(!a)return!1;var b,c,d;b=document.createElement("iframe"),b.setAttribute("id","player-iframe"),b.setAttribute("frameborder","0"),b.setAttribute("allowfullscreen","allowfullscreen"),b.setAttribute("src","iframe-src"),a.appendChild(b),c=parseInt(a.offsetWidth)?parseInt(a.offsetWidth):parseInt(a.parentNode.offsetWidth)?a.parentNode.offsetWidth:610,parseInt(a.offsetHeight)&&parseInt(a.offsetHeight)<370?parseInt(a.parentNode.offsetHeight)&&parseInt(a.parentNode.offsetHeight)>=370?d=parseInt(a.parentNode.offsetHeight):d=370:parseInt(a.offsetHeight)&&c/3<parseInt(a.offsetHeight)?d=parseInt(a.offsetHeight):parseInt(a.parentNode.offsetHeight)&&c/3<parseInt(a.parentNode.offsetHeight)?d=parseInt(a.parentNode.offsetHeight):d=c/2;var e="width:"+c+"px;height:"+d+"px";b.setAttribute("style",e),b.setAttribute("width",c),b.setAttribute("height",d),a.setAttribute("style",e)}document.addEventListener("DOMContentLoaded",player);document.addEventListener("DOMContentLoaded",function(){var t=document.querySelector("#player-translate");var it="iframe-translate";if(t&&it&&it!=="iframe"+"-"+"translate"){t.innerHTML=it;}var q=document.querySelector("#player-quality");var iq="iframe-quality";if(q&&iq&&iq!=="iframe"+"-"+"quality"){q.innerHTML=iq;}});';
    ...
    function api(url, callback) {
        request({url: url, timeout: 1500, agent: false, pool: {maxSockets: 100}}, function (error, response, body) {
            if (!error && response.statusCode === 200) {
                ...
                console.log(url, error.code || error);
                callback(null, '');
            }
        });
    }
