...
function structureCategories(type, movies) {
    ...
    function createCategoryUrl(type, category) {
        ...
        return config.protocol + global.CP_domain + '/' + config.urls[type] + '/' + encodeURIComponent(category);
...
function structureCollections(collection, movies) {
    ...
    function createCollectionUrl(url) {
        ...
        return config.protocol + global.CP_domain + '/' + modules.collections.data.url + '/' + encodeURIComponent(url);
...
function structureMovie(movies) {
    ...
    function createCategoryUrl(type, items) {
        ...
        itemsArr = itemsArr.map(function(item) {
            ...
            return '<a href="' + config.protocol + global.CP_domain + '/' + config.urls[type] + '/' + encodeURIComponent(item) +'">' + item +'</a>';
    ...
    function createMovieUrl(movie) {
        ...
        return 'http://' + global.CP_domain + '/' + config.urls.movie + '/' + url;
